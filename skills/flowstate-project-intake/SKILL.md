---
name: flowstate-project-intake
description: "Apply the FlowState coordination and governance workflow when the concrete scenario is: Identify project, repository, and authority. Produce intake record with evidence and status. Use for scenarios: Identify project, repository, and authority. Do not use for: Do not use outside coordination and governance scenarios; Do not bypass approval, scope, evidence, or safety gates. Expected outputs: intake record; evidence, risks, blockers, and next action."
---

# Flowstate Project Intake

## Scope

- Scenario: Identify project, repository, and authority
- Action: apply the Coordination and Governance workflow within the declared scope
- Intended outcome: intake record
- Project scope: flowstate
- Departments: planning, execution, review
- Stages: discovery, design, implementation, validation
- Category: coordination
- Subcategory: project-intake
- Tags: coordination, project-intake

## Use when

- Identify project, repository, and authority
...
Use when the concrete scenario matches Identify project, repository, and authority.
