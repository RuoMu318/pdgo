...
Implement approved behavior changes with a failing test, minimal implementation, passing verification, and controlled refactoring.

## Routing and department contract

The test must encode an already approved acceptance criterion. Do not weaken or delete a failing test to obtain green. Return the red, green, and refactor evidence with the worker report.
