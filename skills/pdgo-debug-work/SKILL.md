...
Reproduce unexpected behavior, isolate root causes, test hypotheses, and apply only approved bounded remediation.
...
1. **Create Failing Test Case**
   ...
   - Use the `pdgo-tdd-work` skill for writing proper failing tests
...
3. **Verify Fix**
   ...
   - Use the `pdgo-completion-work` skill before claiming success
