...
for (const category of inventory.categories) {
  for (const [skillId, scenario, output] of category.skills) {
    ...
    const spec = {
      ...
      description: `Apply the PDGO ${categoryLabel.toLowerCase()} workflow when the concrete scenario is: ${scenario}. Produce ${output} with evidence and status.`,
      ...
      prerequisites: ["PDGO startup classification", "declared scope"],
